...
public class SportRSS extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lerConteudoGlobo.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {			
				try {
					...
					String url = "http://globoesporte.globo.com/dynamo/semantica/editorias/plantao/futebol/times/sport/feed.rss";
					...
					cabecalho.setText("RSS do Sport Recife - Globo Esporte");
				} catch (Exception e) {
        ...
        lerConteudoMeusport.setOnClickListener(new OnClickListener(){
			...
			try {	
				...
				String url = "http://www.meusport.com/news/rss/all.rss";
				DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
				DocumentBuilder db = dbf.newDocumentBuilder();
				Document doc = db.parse(url);
